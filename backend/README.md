...
## Project Structure
    ...
    ├── women_with_a_purpos_36757  # Django project configurations
...
1. Clone this repo and `cd women_with_a_purpos_36757`
...
2. Clone this repo and `cd women_with_a_purpos_36757`
